...
export class Ce_azure_cloudes_azuremonitorClient {
    ...
    protected processListBySubscription(response: Response): Promise<LogSearchRuleResourceCollection> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? LogSearchRuleResourceCollection.fromJS(resultData200) : <any>null;
            return result200;
            });
        } else {
            return response.text().then((_responseText) => {
...
export class Resource implements IResource {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.tags = data["tags"] ? Tags.fromJS(data["tags"]) : <any>undefined;
        }
    }
...
export class LogSearchRuleResource extends Resource implements ILogSearchRuleResource {
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.properties = data["properties"] ? LogSearchRule.fromJS(data["properties"]) : <any>undefined;
        }
    }
...
export class LogSearchRuleResourcePatch implements ILogSearchRuleResourcePatch {
    ...
    init(data?: any) {
        if (data) {
            this.tags = data["tags"] ? Tags2.fromJS(data["tags"]) : <any>undefined;
